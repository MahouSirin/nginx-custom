#define NGX_CONFIGURE " --with-cc-opt='-Wno-stringop-truncation -DTCP_FASTOPEN=23 -m64 -lm -g -O3 -march=native -fstack-protector-strong -fuse-ld=gold -fuse-linker-plugin --param=ssp-buffer-size=4 -Wformat -Werror=format-security -Wno-strict-aliasing -Wp,-D_FORTIFY_SOURCE=2 -gsplit-dwarf -DNGX_HTTP_HEADERS' --with-ld-opt='-lrt -ljemalloc -Wl,-z,relro -Wl,-z,now -fPIC' --with-openssl-opt='no-cmp enable-weak-ssl-ciphers no-ssl3-method -march=native -ljemalloc' --builddir=objs --prefix=/etc/nginx --conf-path=/etc/nginx/nginx.conf --pid-path=/var/run/nginx.pid --lock-path=/var/lock/nginx.lock --http-log-path=/var/log/nginx/access.log --error-log-path=/var/log/nginx/error.log --sbin-path=/usr/sbin/nginx --http-client-body-temp-path=/var/lib/nginx/client_body_temp --http-proxy-temp-path=/var/lib/nginx/proxy_temp --http-fastcgi-temp-path=/var/lib/nginx/fastcgi_temp --http-scgi-temp-path=/var/lib/nginx/scgi_temp --http-uwsgi-temp-path=/var/lib/nginx/uwsgi_temp --with-zlib=./lib/zlib --with-openssl=./lib/boringssl --with-http_realip_module --with-http_addition_module --with-http_sub_module --with-http_dav_module --with-http_stub_status_module --with-http_flv_module --with-http_mp4_module --with-http_gunzip_module --with-http_slice_module --with-http_gzip_static_module --with-http_auth_request_module --with-http_dav_module --with-http_random_index_module --with-http_secure_link_module --with-http_image_filter_module --with-file-aio --with-threads --with-libatomic --with-mail --with-compat --with-stream --with-http_ssl_module --with-mail_ssl_module --with-http_v2_module --with-http_v3_module --with-stream_quic_module --with-stream_ssl_module --with-stream_realip_module --with-stream_ssl_preread_module --add-module=./lib/ngx_devel_kit --add-module=./lib/ngx_brotli --add-module=./lib/headers-more-nginx-module --add-module=./lib/nginx-http-flv-module --add-module=./lib/naxsi/naxsi_src --add-module=./lib/nginx-dav-ext-module --add-module=./lib/ngx-fancyindex --add-module=./lib/ngx_http_geoip2_module --add-module=./lib/nginx-module-vts"
...
#ifndef NGX_HAVE_LIBATOMIC
#define NGX_HAVE_LIBATOMIC  1
#endif
...
#define NGX_HTTP_CLIENT_TEMP_PATH  "/var/lib/nginx/client_body_temp"
#endif


#ifndef NGX_HTTP_PROXY_TEMP_PATH
#define NGX_HTTP_PROXY_TEMP_PATH  "/var/lib/nginx/proxy_temp"
#endif


#ifndef NGX_HTTP_FASTCGI_TEMP_PATH
#define NGX_HTTP_FASTCGI_TEMP_PATH  "/var/lib/nginx/fastcgi_temp"
#endif


#ifndef NGX_HTTP_UWSGI_TEMP_PATH
#define NGX_HTTP_UWSGI_TEMP_PATH  "/var/lib/nginx/uwsgi_temp"
#endif


#ifndef NGX_HTTP_SCGI_TEMP_PATH
#define NGX_HTTP_SCGI_TEMP_PATH  "/var/lib/nginx/scgi_temp"
#endif
